...
const cajaCompleta = { ...caja, ...envoltorio }; //Rest operator para unir objetos tiene la extructura de un objeto donde dentro ponemos los objetos que quieres unir con anteriormente 3 puntos y separado por COMA
